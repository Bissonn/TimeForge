...
from tests.monitoring.test_gradient_monitor import run_context
from utils.dataset import TimeSeriesDataset


def test_lstm_iterative_pc_adapter_matches_legacy_predictions(base_context):
    """
    E2E contract test:
    Iterative LSTM with PCModeInputAdapter must produce
    ...
    target_cols = ["y"]
    enc_cols = ["p1", "c1"]   # p1 = P, c1 = C
    dec_cols = ["c1"]         # shared => Continuous
    ...
    model = LSTMForecaster(
        model_params={
            ...
            "dropout": 0.0,
            "strategy": "iterative",
            "future_covariate_mode": "stepwise",  # Enable future covariates
            "epochs": 1,
            "batch_size": 2,
        },
        num_features=1,
